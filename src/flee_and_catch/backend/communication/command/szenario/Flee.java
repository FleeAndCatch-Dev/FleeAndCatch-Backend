...
public class Flee extends Szenario {
	
	public Flee(int pId, String pType, String pCommand, String pMode, ArrayList<App> pApps, ArrayList<Robot> pRobots, Steering pSteering) {
		super(pId, pType, pCommand, pMode, pApps, pRobots, pSteering);
	}
	
	public Flee(Flee pControl) {
